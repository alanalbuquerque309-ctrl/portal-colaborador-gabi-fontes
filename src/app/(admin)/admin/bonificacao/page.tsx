...
export default function AdminBonificacaoPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-2xl text-coffee-base font-semibold">Índice interno (bonificação)</h1>
      ...
      <div className="flex flex-wrap gap-4 items-end bg-white border border-cream-300 rounded-xl p-4">
        <div>
          <label htmlFor="mes-bon" className="block text-sm font-medium text-coffee-base mb-1">
            Mês
          </label>
          <input
            id="mes-bon"
        ...
        <div>
          <label htmlFor="uni-bon" className="block text-sm font-medium text-coffee-base mb-1">
            Filial
          </label>
          <select
            id="uni-bon"
