...
import { TermometroEntradaGate } from '@/components/emocional/TermometroEntradaGate';
        ...
        <div className="space-y-8">
          ...
          <PortalHomeSecaoAdiada minHeight="8rem">
            <section
              ...
              className="rounded-2xl border border-terracota-200/70 bg-gradient-to-br from-terracota-50/60 via-white to-cream-50 p-4 sm:p-5 shadow-sm"
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-xl font-display font-semibold text-cafeteria-900">
                    Termômetro de emoções
                  </h2>
                  <p className="text-sm text-cafeteria-600 mt-0.5">
                    Registre como está hoje. Liderança, RH e gestão veem sua resposta.
                  </p>
                </div>
              </div>
              <TermometroEmocional />
