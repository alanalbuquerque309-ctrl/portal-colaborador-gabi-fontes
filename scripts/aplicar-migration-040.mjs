/**
 * Aplica supabase/migrations/040_avaliacao_ignorada.sql
 * Uso: npm run db:apply-040
 */
import fs from 'fs';
...
const sqlPath = path.join(portalRoot, 'supabase', 'migrations', '040_avaliacao_ignorada.sql');
